            ...
            <div className="flex-center_content">
                ...
                <div className="horaire">
                    ...
                    <h2 className='txt-center'>Horaire & informations</h2>
                            ...
                            <form className='contact-form' ref={form} onSubmit={sendEmail}>  
                            <label htmlFor="user_name1">Nom:*</label>
                            <input type="text" required='required' name="user_name" placeholder='Anne' id='user_name1' />
                            <label htmlFor="user_email1">Email:*</label>
                            <input type="email" required='required' name="user_email" placeholder='exemple@gmail.com' id='user_email1' />
                            <label htmlFor="message1">Message:*</label>
                            <textarea required="required" name="message" placeholder='Bonjour, je souhaiterais prendre rendez-vous...' id='message1'/>
                            <input type="submit" value="Envoyer" />
                                        </form>
                            </div>
                    </div>
